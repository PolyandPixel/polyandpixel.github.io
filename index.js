                ...
                <div top-part class="flex items:start just:between w:fit m-b:200fx d:block@m m-b:37fx@m">
                    ...
                    <div class="(&//ul//li):m-b:10fx@m  space-x:44fx fs:16fx lh:1.2 flex items:start just:end just:between@m">
                        <ul class="w:174fx">
                            ...
                            <li><a class="underlined-link" href="/coming-soon">About</a></li>
                            <li><a class="underlined-link" href="/coming-soon">Services & Models</a></li>
                ...
                <div>
                    ...
                    <div top-part class="flex items:end just:between w:fit m-b:69fx m-b:30fx@m items:start@m">
                        <div class="fs:16fx w:218fx@m space-y:20fx@m">
                            ...
                            <ul class="">
                                <li style="min-height: calc(20* var(--unit-fx));"><span>HQ: 71 Union Ave<span></li>
<li style="min-height: calc(20* var(--unit-fx));"><span>Rutherford</span></li>
                                <li style="min-height: calc(20* var(--unit-fx));"><span>New Jersey 07070</span></li>
                            </ul>
                            <p class="d:none d:block@m">
                                <span>©2024</span> 
                                <a href="/coming-soon" class="underlined-link">legal</a>
                            </p>
                        </div>
                        <div class="space-x:44fx fs:16fx flex items:end just:end space-x:0@m">
                            ...
                            <p class="d:none@m">
                                ©2024 <a href="/coming-soon" class="underlined-link">legal</a>
                            </p>
                        </div>
                    </div>
    ...
    >
      ...
      >
        <p class="__m-b:1em">
          ...
          deploy cookies as detailed in our <a href="/coming-soon">Privacy Policy</a>.
        </p>
